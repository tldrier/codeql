...
public class ExtractorConfig {
  ...
  private HtmlExtractor.Config htmlHandling;
  ...
  public ExtractorConfig(boolean experimental) {
    ...
    this.htmlHandling = HtmlExtractor.Config.ELEMENTS;
  ...
  public HtmlExtractor.Config getHtmlHandling() {
    return htmlHandling;
  }

  public ExtractorConfig withHtmlHandling(HtmlExtractor.Config htmlHandling) {
    ExtractorConfig res = new ExtractorConfig(this);
